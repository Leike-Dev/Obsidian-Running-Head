export const ptBR = {
	...
	'render_custom_title_name': 'Exibir título nativo pelo plugin',
	'render_custom_title_desc': 'Injeta e exibe o título da nota no cabeçalho. Útil se você usa o Obsidian sem o "Mostrar título in-line" ativado.',
...
// ================================================================
	...
	'add_tab_property_name': 'Nova propriedade de aba',
	'add_tab_property_desc': 'Adiciona uma propriedade do frontmatter para ser renderizada como link de aba no cabeçalho.',
	'add_tab_property_button': 'Adicionar',
	'manage_tab_properties_name': 'Gerenciar propriedades de abas',
	'manage_tab_properties_desc': 'Edite ou remova as propriedades de abas configuradas.',
	'manage_tab_properties_button': 'Gerenciar',
	'tab_editor_title_add': 'Adicionar propriedade de aba',
	'tab_editor_title_edit': 'Editar propriedade de aba',
	'tab_property_name': 'Chave YAML',
	'tab_property_desc': 'Nome da propriedade no frontmatter da nota.',
	'tab_property_required': 'Insira a chave YAML para esta propriedade de aba.',
	'tab_property_order': 'Ordem de exibição',
	'tab_property_order_desc': 'Ordem numérica para renderização (valores menores aparecem primeiro).',
	'tab_property_show_icon': 'Exibir ícone',
	'tab_property_show_icon_desc': 'Renderiza o ícone especificado por [icon, nome] se presente.',
	'tab_property_added': 'Propriedade de aba "{key}" criada.',
	'tab_property_updated': 'Propriedade de aba "{key}" atualizada.',
	'tab_property_deleted': 'Propriedade de aba "{name}" removida.',
	'tab_manager_title': 'Gerenciar propriedades de abas',
	'tab_manager_count': '{count} propriedade(s) de aba',
	'tab_manager_empty': 'Nenhuma propriedade de aba configurada ainda.',
	'icon_picker_placeholder': 'Buscar por um ícone...',
	'icon_picker_copy_button': 'Seletor de ícones (copiar tag)',
	'icon_picker_copy_desc': 'Busque por qualquer ícone Lucide e clique para copiar sua tag para a área de transferência.',
	'add_button': 'Escolher',
	'icon_picker_copy_notice': 'Copiado {tag} para a área de transferência!',
