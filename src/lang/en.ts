...
// ================================================================
	...
	'add_tab_property_name': 'New tab property',
	'add_tab_property_desc': 'Add a frontmatter property to be rendered as a tab link in the header.',
	'add_tab_property_button': 'Add',
	'manage_tab_properties_name': 'Manage tab properties',
	'manage_tab_properties_desc': 'Edit or remove configured tab properties.',
	'manage_tab_properties_button': 'Manage',
	'tab_editor_title_add': 'Add tab property',
	'tab_editor_title_edit': 'Edit tab property',
	'tab_property_name': 'YAML key',
	'tab_property_desc': 'Property name in the note\'s frontmatter.',
	'tab_property_required': 'Enter the YAML key for this tab property.',
	'tab_property_order': 'Display order',
	'tab_property_order_desc': 'Numerical order for rendering (lower values appear first).',
	'tab_property_show_icon': 'Show icon',
	'tab_property_show_icon_desc': 'Render the icon specified by [icon, name] if present.',
	'tab_property_added': 'Tab property "{key}" created.',
	'tab_property_updated': 'Tab property "{key}" updated.',
	'tab_property_deleted': 'Tab property "{name}" removed.',
	'tab_manager_title': 'Manage tab properties',
	'tab_manager_count': '{count} tab property(ies)',
	'tab_manager_empty': 'No tab properties configured yet.',
	'icon_picker_placeholder': 'Search for an icon...',
	'icon_picker_copy_button': 'Icon selector (copy tag)',
	'icon_picker_copy_desc': 'Search for any Lucide icon and click to copy its tag to clipboard.',
	'add_button': 'Choose',
	'icon_picker_copy_notice': 'Copied {tag} to clipboard!',
