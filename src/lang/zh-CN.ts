...
// ================================================================
	...
	// ================================================================
	'section_tabs': '标签导航',
	'add_tab_property_name': '新建标签属性',
	'add_tab_property_desc': '添加一个 frontmatter 属性以在页眉中渲染为标签链接。',
	'add_tab_property_button': '添加',
	'manage_tab_properties_name': '管理标签属性',
	'manage_tab_properties_desc': '编辑或删除已配置的标签属性。',
	'manage_tab_properties_button': '管理',
	'tab_editor_title_add': '添加标签属性',
	'tab_editor_title_edit': '编辑标签属性',
	'tab_property_name': 'YAML 键',
	'tab_property_desc': '笔记 frontmatter 中的属性名称。',
	'tab_property_required': '请输入此标签属性的 YAML 键。',
	'tab_property_order': '显示顺序',
	'tab_property_order_desc': '渲染的数字顺序（较小的值先显示）。',
	'tab_property_show_icon': '显示图标',
	'tab_property_show_icon_desc': '如果存在 [icon, 名称]，则渲染指定的图标。',
	'tab_property_added': '标签属性 "{key}" 已创建。',
	'tab_property_updated': '标签属性 "{key}" 已更新。',
	'tab_property_deleted': '标签属性 "{name}" 已删除。',
	'tab_manager_title': '管理标签属性',
	'tab_manager_count': '{count} 个标签属性',
	'tab_manager_empty': '尚未配置标签属性。',
	'icon_picker_placeholder': '搜索图标...',
	'icon_picker_copy_button': '图标选择器（复制标签）',
	'icon_picker_copy_desc': '搜索任意 Lucide 图标并点击复制其标签到剪贴板。',
	'add_button': '选择',
	'icon_picker_copy_notice': '已复制 {tag} 到剪贴板！',
